...
class StageModule(nn.Module):
    def __init__(self, input_branches, output_branches, c,o,
                 cur = 0,
                 in_chans=3,
                 num_classes=1000,
                 depths=(3, 3, 27, 3),
        ...
        for t in range(self.input_branches):  # 每个分支上都先通过4个BasicBlock
            dim = dims[o] * (2 ** t)  # 对应第i个分支的通道数
            print("dim",dim)
            branch = nn.Sequential(
                *[UniRepLKNetBlock(dim=dim, kernel_size=kernel_sizes[i][j], drop_path=dp_rates[cur + j],
...
def merge_dilated_into_large_kernel(large_kernel, dilated_kernel, dilated_r):
    ...
    equivalent_kernel_size = dilated_r * (dilated_k - 1) + 1        #（k-1）r+1
...
class HrHighResolutionNet(nn.Module):
    def __init__(self, base_channel: int = 32, num_joints: int = 17):
        ...
        self.stage2 = nn.Sequential(
            StageModule(input_branches=2, output_branches=2, c=base_channel,o=1)
        )
        ...
        self.stage3 = nn.Sequential(
            StageModule(input_branches=3, output_branches=3, c=base_channel,o=2),
            StageModule(input_branches=3, output_branches=3, c=base_channel,o=2),
            StageModule(input_branches=3, output_branches=3, c=base_channel,o=2),
            StageModule(input_branches=3, output_branches=3, c=base_channel,o=2)
        )
        ...
        self.stage4 = nn.Sequential(
            StageModule(input_branches=4, output_branches=4, c=base_channel,o=3),
            StageModule(input_branches=4, output_branches=4, c=base_channel,o=3),
            StageModule(input_branches=4, output_branches=1, c=base_channel,o=3)
        )
